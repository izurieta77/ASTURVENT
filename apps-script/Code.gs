...
var CLIENTE_NAMES = {
  "TGIO":       "THD GIO",
  "TALF":       "THD ALFREDO COLIN",
  "GAJ":        "GAJU",
  "DEH":        "TRANSPORTES DEHUI SA DE CV",
  "DHAR":       "DON HARINA / WAWITA",
  "PANF":       "PLASTICOS INDUSTRIALES (PANFILO MENDEZ)",
  "RECA":       "RECA COMUNICACIONES",
  "MAC":        "MACERE",
  "AST":        "ASTURVENT",
  "ATZ":        "ATZUZI",
  "GZAR":       "G PUNTO Z ARQUITECTOS",
  "SERI":       "GRUPO SERICAL SA DE CV",
  "GRUV":       "GRUVIMEX",
  "DEL":        "DELTEX",
  "ECOM":       "ECOM",
  "ISM":        "GRUTACOS / ISMAEL CONTRERAS COLIN",
  "AMSC":       "AMSC CONSTRURAMA",
  "ISA":        "ISA ALIMENTOS",
  "ROG":        "LOGISTICA ROGO SA DE CV",
  "LMAN":       "LAVANDERIA LOS MANANTIALES SA DE CV",
  "LTOL":       "LAMINAS TOLUCA",
  "CEMI":       "CEMI AUTOMATION SA DE CV",
  "PORTUR":     "PORTUR",
  "TECNO":      "TECNO ILUMINACION OH SA DE CV",
  "PUROSON":    "PURO SONORA (JANB)",
  "VENETIAMOT": "MOTEL VENETIA OPERADORA HOTELERA BECSA",
  "TOLUT":      "TOLUTEL SA DE CV"
};
...
function doPost(e) {
  ...
  try {
    ...
    return jsonResponse_({ ok: false, error: 'Accion no reconocida: ' + action });
  } catch (err) {
...
function subirFotoDrive_(body) {
  ...
  if (!base64) return { ok: false, error: 'No se recibio base64' };
