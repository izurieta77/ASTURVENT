# 🛡️ App SGM Mobil Metepec — Guía Completa de Beneficios · Cliente THD GIO

### Ecosistema de Precisión · Combustibles Synergy™ + Lubricantes Mobil 1™ · Distribuidor Autorizado ExxonMobil

> **Para THD GIO.** Como cliente de flotilla de **SGM Mobil Metepec**, tienes un
> **Portal de Cliente digital** gratuito donde ves **en tiempo real** todo lo que tu
> flotilla consume con nosotros: litros, montos, choferes, unidades, rendimiento,
> gráficas y un **analista con Inteligencia Artificial**.
>
> Este documento explica **todas las funciones y beneficios**, con **capturas de
> pantalla reales** tomadas con la cuenta de **THD GIO**.
...
- Entras como **Cliente**, eliges **THD GIO** y escribes tu **clave de acceso**.
...
![Pantalla de acceso](capturas-tgio/00-login.png)

**Beneficio:** acceso inmediato, seguro y sin costo. Solo tú ves la información de
**THD GIO**; ningún otro cliente puede verla.
...
![Pestaña Gráficas](capturas-tgio/02-graficas.png)
...
![Pestaña Autorizaciones](capturas-tgio/03-autorizaciones.png)
...
![Pestaña Rendimiento](capturas-tgio/04-rendimiento.png)
...
![Pestaña Mis Unidades](capturas-tgio/05-mis-unidades.png)
...
![Pestaña Bitácora](capturas-tgio/06-bitacora.png)
...
![Pestaña IA](capturas-tgio/07-ia.png)
...
## ✅ Resumen de beneficios para THD GIO
...
1. Pídenos tu **clave de acceso** (la creamos para THD GIO).
2. Entra a **`https://appsgm.netlify.app`** → pestaña **Cliente**.
3. Elige **THD GIO**, escribe tu clave y **listo**: ya ves toda tu flotilla.
...
*Documento generado con capturas reales del portal del cliente THD GIO. Las cifras
mostradas corresponden al período consultado y cambian según tus cargas reales.*
